...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_category'
        db.add_column(u'insuranceimapp_userprofile', 'user_category',
                      self.gf('django.db.models.fields.CharField')(default='user', max_length=15),
                      keep_default=False)

        # Adding field 'UserProfile.first_name'
        db.add_column(u'insuranceimapp_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'UserProfile.surname_first_letter'
        db.add_column(u'insuranceimapp_userprofile', 'surname_first_letter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)

        # Adding field 'UserProfile.zipcode'
        db.add_column(u'insuranceimapp_userprofile', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'UserProfile.city'
        db.add_column(u'insuranceimapp_userprofile', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'UserProfile.six_digit_code'
        db.add_column(u'insuranceimapp_userprofile', 'six_digit_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Deleting field 'Message.content'
        db.delete_column(u'insuranceimapp_message', 'content')

        # Adding field 'Message.product_name'
        db.add_column(u'insuranceimapp_message', 'product_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'Message.product_value'
        db.add_column(u'insuranceimapp_message', 'product_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_category'
        db.delete_column(u'insuranceimapp_userprofile', 'user_category')

        # Deleting field 'UserProfile.first_name'
        db.delete_column(u'insuranceimapp_userprofile', 'first_name')

        # Deleting field 'UserProfile.surname_first_letter'
        db.delete_column(u'insuranceimapp_userprofile', 'surname_first_letter')

        # Deleting field 'UserProfile.zipcode'
        db.delete_column(u'insuranceimapp_userprofile', 'zipcode')

        # Deleting field 'UserProfile.city'
        db.delete_column(u'insuranceimapp_userprofile', 'city')

        # Deleting field 'UserProfile.six_digit_code'
        db.delete_column(u'insuranceimapp_userprofile', 'six_digit_code')

        # Adding field 'Message.content'
        db.add_column(u'insuranceimapp_message', 'content',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Deleting field 'Message.product_name'
        db.delete_column(u'insuranceimapp_message', 'product_name')

        # Deleting field 'Message.product_value'
        db.delete_column(u'insuranceimapp_message', 'product_value')
